...
export function newJFXTitleBar(title: string) {
    return (
        component("div", { className: "jfx-title" },
            component("div", { className: "jfx-java-logo" }),
            component("div", { className: "jfx-window-name" }, title),
            component("div", { className: "jfx-windows-options" },
                component("div", { className: "jfx-minimize" }),
                component("div", { className: "jfx-restore" }),
                component("div", { className: "jfx-close" }),
            )
        )
    )
}
...
export function newJFXWindow(title: string, ...children: (Node | string)[]) {
    return component("div", { className: "jfx-window" },
        newJFXTitleBar(title),
        newJFXPanel(...children)
    )
}
...
export function newHomePage() {
    ...
    const page = newJFXWindow(
        "Seminário de Engenharia de Software I",
        component("h1", {}, "Seminário de Engenharia de Software I"),
        component("h2", {},
            newJFXButton("Repository"),
            newJFXButton("Diamante da Morte"),
            newJFXButton("Herança Negada"),
            newJFXButton("Números Mágicos"),
        ),
        component("span", {},
            newJFXField(...names.map(n => component("div", {}, n))),
            component("div", {}, "Profª Kattiana Constantino"),
        )
    )
