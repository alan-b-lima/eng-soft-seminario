...
var hljs = function () {
    ...
    function a(e, ...n) {
        ...
        for (const n in e)
            t[n] = e[n];
        return n.forEach((e => { for (const n in e)
            t[n] = e[n]; })), t;
    }
    const i = e => !!e.scope;
    class r {
        ...
        closeNode(e) { i(e) && (this.buffer += "</span>"); }
    ...
    function b(...e) { return e.map((e => c(e))).join(""); }
    function m(...e) {
        const n = (e => {
    ...
    }, k = { scope: "string", begin: "'", end: "'",
        illegal: "\\n", contains: [N] }, x = { scope: "string", begin: '"', end: '"', illegal: "\\n",
        contains: [N] }, O = (e, n, t = {}) => {
        const i = a({ scope: "comment", begin: e, end: n,
            contains: [] }, t);
        i.contains.push({ scope: "doctag",
    ...
    var C = Object.freeze({
        __proto__: null, APOS_STRING_MODE: k, BACKSLASH_ESCAPE: N, BINARY_NUMBER_MODE: {
            scope: "number", begin: v, relevance: 0
        }, BINARY_NUMBER_RE: v, COMMENT: O,
        ...
        }), HASH_COMMENT_MODE: S, IDENT_RE: f,
    ...
    function W(e) {
        ...
        return e.classNameAliases = a(e.classNameAliases || {}), function t(r, s) {
            ...
            return "object" == typeof r.keywords && r.keywords.$pattern && (r.keywords = Object.assign({}, r.keywords),
                ...
                variants: null
            }, n)))), e.cachedVariants ? e.cachedVariants : Q(e) ? a(e, {
    ...
    const V = t, J = a, Y = Symbol("nomatch"), ee = t => {
        ...
        function f(e, t, i, r) {
            ...
            function c() {
                ...
                for (; n;) {
                    ...
                    const i = v.case_insensitive ? n[0].toLowerCase() : n[0], r = (a = i, O.keywords[a]);
                    if (r) {
                        const [e, a] = r;
                        if (A.addText(t), t = "", l[i] = (l[i] || 0) + 1, l[i] <= 7 && (C += a), e.startsWith("_"))
                            t += n[0];
                        else {
            ...
            function u(e, n) {
                ...
                for (; t <= a;) {
                    ...
                    const a = v.classNameAliases[e[t]] || e[t], i = n[t];
                    a ? g(i, a) : (S = i, c(), S = ""), t++;
                }
            }
            function b(e, n) {
            ...
            function h(e) {
                const n = e[0], a = t.substring(e.index), i = m(O, e, a);
                if (!i)
                    return Y;
                const r = O;
            ...
            function w(a, r) {
                ...
                if (y = r, "begin" === r.type)
                    return (e => {
                        ...
                        for (const n of r)
                            if (n && (n(e, i), i.isMatchIgnored))
                                return _(t);
                        return a.skip ? S += t : (a.excludeBegin && (S += t),
                            d(), a.returnBegin || a.excludeBegin || (S = t)), b(a, e), a.returnBegin ? 0 : t.length;
                    })(r);
                if ("illegal" === r.type && !i) {
            ...
            const k = W(v);
            let x = "", O = r || k;
            const M = {}, A = new p.__emitter(p);
            (() => {
                const e = [];
                for (let n = O; n !== v; n = n.parent)
                    n.scope && e.unshift(n.scope);
                e.forEach((e => A.openNode(e)));
            })();
            let S = "", C = 0, T = 0, R = 0, D = !1;
            try {
                if (v.__emitTokens)
                    v.__emitTokens(t, A);
                else {
                ...
                return A.finalize(), x = A.toHTML(), { language: e,
                    value: x, relevance: C, illegal: !1, _emitter: A, _top: O };
            }
            catch (n) {
                if (n.message && n.message.includes("Illegal"))
                    return { language: e, value: V(t),
                        illegal: !0, relevance: 0, _illegalBy: { message: n.message, index: T,
                            context: t.slice(T - 100, T + 100), mode: n.mode, resultSoFar: x }, _emitter: A };
                if (s)
                    return {
        ...
        function E(e, n) {
            ...
            })(e), i = n.filter(N).filter(x).map((n => f(n, e, !1)));
            i.unshift(t);
            const r = i.sort(((e, n) => {
                if (e.relevance !== n.relevance)
                    return n.relevance - e.relevance;
                if (e.language && n.language) {
                    if (N(e.language).supersetOf === n.language)
                        return 1;
                    if (N(n.language).supersetOf === e.language)
                        return -1;
                }
                return 0;
            })), [s, o] = r, l = s;
        ...
        function y(e) {
            ...
            if (e.children.length > 0 && (p.ignoreUnescapedHTML || (console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),
                ...
                console.warn(e)), p.throwUnescapedHTML))
        ...
        function v() {
            if ("loading" === document.readyState)
                return w || window.addEventListener("DOMContentLoaded", (() => {
                    v();
                }), !1), void (w = !0);
        ...
        Object.assign(t, { highlight: h, highlightAuto: E, highlightAll: v,
            highlightElement: y,
            ...
            autoDetection: x, inherit: J, addPlugin: e => {
                (e => {
            ...
            s = !1;
        }, t.safeMode = () => { s = !0; }, t.versionString = "11.11.1", t.regex = { concat: b,
    ...
    function be(e, n, t) { return -1 === t ? "" : e.replace(n, (a => be(e, n, t - 1))); }
    ...
    function ve(e) {
        ...
        return { name: "JavaScript", aliases: ["js", "jsx", "mjs", "cjs"], keywords: i, exports: {
            ...
            contains: [e.SHEBANG({ label: "shebang", binary: "node", relevance: 5 }), {
                    ...
                    scope: "attr", match: t + n.lookahead(":"), relevance: 0
                }, M, {
    ...
    var Ue = Object.freeze({ __proto__: null, grmr_bash: e => {
            const n = e.regex, t = {}, a = {
            ...
            const n = e.regex, t = e.COMMENT("//", "$", { contains: [{ begin: /\\\n/ }]
                ...
                keywords: u, illegal: /[^\w\s\*&:<>.]/, contains: [{ begin: a, keywords: u, relevance: 0 }, {
                        ...
                        relevance: 0
                    }, { relevance: 0, match: /,/ }, { className: "params", begin: /\(/, end: /\)/,
                        keywords: u, relevance: 0, contains: [t, e.C_BLOCK_COMMENT_MODE, o, l, s, { begin: /\(/,
                                end: /\)/, keywords: u, relevance: 0, contains: ["self", t, e.C_BLOCK_COMMENT_MODE, o, l, s]
                            }] }, s, t, e.C_BLOCK_COMMENT_MODE, c]
            };
            return { name: "C", aliases: ["h"], keywords: u,
                disableAutodetect: !0, illegal: "</", contains: [].concat(m, p, b, [c, {
                        begin: e.IDENT_RE + "::", keywords: u
                    }, { className: "class",
                        beginKeywords: "enum class struct union", end: /[{;:<>=]/, contains: [{
                                beginKeywords: "final class struct"
                            }, e.TITLE_MODE] }]), exports: { preprocessor: c,
            ...
            const n = {
                ...
                keywords: n }, o = e.inherit(s, { illegal: /\n/ }), l = { className: "string", begin: /\$"/,
                        ...
                        begin: /\{\{/
                    }, { begin: /\}\}/ }, { begin: '""' }, s] }, d = e.inherit(c, { illegal: /\n/,
            ...
            return { name: "Go", aliases: ["golang"], keywords: n, illegal: "</",
                contains: [e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, { className: "string",
                        ...
                        begin: /:=/
                    }, { className: "function", beginKeywords: "func", end: "\\s*(\\{|$)",
                        excludeEnd: !0, contains: [e.TITLE_MODE, { className: "params", begin: /\(/, end: /\)/,
                                endsParent: !0, keywords: n, illegal: /["']/ }] }] };
        }, grmr_graphql: e => {
            const n = e.regex;
            ...
            a.variants = [{ begin: /;/, end: /$/ }, { begin: /#/,
                    end: /$/ }];
            const i = { className: "variable", variants: [{ begin: /\$[\w\d"][\w\d_]*/ }, {
                        begin: /\$\{(.*?)\}/
                    }] }, r = { className: "literal",
            ...
            const n = e.regex, t = "[\xc0-\u02b8a-zA-Z_$][\xc0-\u02b8a-zA-Z_$0-9]*", a = t + be("(?:<" + t + "~~~(?:\\s*,\\s*" + t + "~~~)*>)?", /~~~/g, 2), i = {
                ...
                built_in: ["super", "this"]
            }, r = { className: "meta", begin: "@" + t, contains: [{
                        begin: /\(/, end: /\)/, contains: ["self"]
                    }] }, s = { className: "params", begin: /\(/,
            ...
            return { name: "Java", aliases: ["jsp"], keywords: i, illegal: /<\/|#/,
                contains: [e.COMMENT("/\\*\\*", "\\*/", { relevance: 0, contains: [{ begin: /\w+@/,
                    ...
                    }, { begin: [/record/, /\s+/, t], className: { 1: "keyword",
                            3: "title.class" }, contains: [s, e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE] }, {
                        beginKeywords: "new throw return else", relevance: 0
                    }, {
                        begin: ["(?:" + a + "\\s+)", e.UNDERSCORE_IDENT_RE, /\s*(?=\()/], className: {
                            2: "title.function"
                        }, keywords: i, contains: [{ className: "params", begin: /\(/,
        ...
        grmr_json: e => {
            const n = ["true", "false", "null"], t = { scope: "literal",
                beginKeywords: n.join(" ") };
            return { name: "JSON", aliases: ["jsonc"], keywords: {
                    literal: n
                ...
                { name: "Kotlin", aliases: ["kt", "kts"], keywords: n,
                    contains: [e.COMMENT("/\\*\\*", "\\*/", { relevance: 0, contains: [{ className: "doctag",
                            ...
                            illegal: "extends implements", contains: [{
                                    ...
                                    excludeBegin: !0, returnEnd: !0 }, s, o]
                        }, r, { className: "meta", begin: "^#!/usr/bin/env",
                            end: "$", illegal: "\n" }, l] };
        }, grmr_less: e => {
            const n = te(e), t = le, a = "[\\w-]+", i = "(" + a + "|@\\{" + a + "\\})", r = [], s = [], o = e => ({
                className: "string", begin: "~?" + e + ".*?" + e
            }), l = (e, n, t) => ({ className: e, begin: n,
            ...
            }), u = { beginKeywords: "when", endsWithParent: !0,
        ...
        grmr_objectivec: e => {
            ...
            const n = e.regex, t = /[dualxmsipngr]{0,12}/, a = {
                ...
                return n.concat(n.concat("(?:", e, ")"), a, /(?:\\.|[^\\\/])*?/, r, /(?:\\.|[^\\\/])*?/, i, t);
                    ...
                    endsWithParent: !0
                }), r, { className: "string", contains: c, variants: [{
                    ...
                    contains: [e.HASH_COMMENT_MODE, { className: "regexp", variants: [{
                            ...
                            className: "regexp", variants: [{ begin: /(m|qr)\/\//, relevance: 0 }, {
                                    begin: u("(?:m|qr)?", /\//, /\//)
                                }, { begin: u("m|qr", n.either(...d, { capture: !0
                                    }), /\1/) }, { begin: u("m|qr", /\(/, /\)/) }, { begin: u("m|qr", /\[/, /\]/) }, {
                                    begin: u("m|qr", /\{/, /\}/)
                                }]
                        }]
                }, { className: "function", beginKeywords: "sub method",
                    ...
                    contains: [e.TITLE_MODE, s, l] }, { begin: "-\\w\\b", relevance: 0 }, { begin: "^__DATA__$",
                            ...
                            className: "comment" }] }];
            return i.contains = b, r.contains = b, { name: "Perl",
                aliases: ["pl", "pm"], keywords: a, contains: b };
        }, grmr_php: e => {
            const n = e.regex, t = /(?![A-Za-z0-9])(?![$])/, a = n.concat(/[a-zA-Z_\x7f-\xff][a-zA-Z0-9_\x7f-\xff]*/, t), i = n.concat(/(\\?[A-Z][a-z0-9_\x7f-\xff]+|\\?[A-Z]+(?=[A-Z][a-z0-9_\x7f-\xff])){1,}/, t), r = n.concat(/[A-Z]+/, t), s = {
                ...
                scope: { 3: "title.function.invoke" }, contains: [w] };
            w.contains.push(v);
            const N = [y, E, e.C_BLOCK_COMMENT_MODE, d, g, h], k = {
                ...
                endScope: "meta", keywords: { literal: u, keyword: ["new", "array"] }, contains: [{
                        ...
                        contains: ["self", ...N]
                    }, ...N, { scope: "meta", variants: [{ match: i }, { match: r }] }]
            };
            return { case_insensitive: !1, keywords: p,
                contains: [k, e.HASH_COMMENT_MODE, e.COMMENT("//", "$"), e.COMMENT("/\\*", "\\*/", {
                        ...
                        keywords: "__halt_compiler", starts: { scope: "comment", end: e.MATCH_NOTHING_RE,
                            contains: [{ match: /\?>/, scope: "meta", endsParent: !0 }] } }, { scope: "meta", variants: [{
                                ...
                                begin: /\?>/
                            }] }, { scope: "variable.language", match: /\$this\b/ }, s, v, E, {
                ...
                }] }), grmr_plaintext: e => ({ name: "Plain text",
        ...
        grmr_python_repl: e => ({ aliases: ["pycon"], contains: [{ className: "meta.prompt",
                    ...
                    built_in: "LETTERS letters month.abb month.name pi T F abs acos acosh all any anyNA Arg as.call as.character as.complex as.double as.environment as.integer as.logical as.null.default as.numeric as.raw asin asinh atan atanh attr attributes baseenv browser c call ceiling class Conj cos cosh cospi cummax cummin cumprod cumsum digamma dim dimnames emptyenv exp expression floor forceAndCall gamma gc.time globalenv Im interactive invisible is.array is.atomic is.call is.character is.complex is.double is.environment is.expression is.finite is.function is.infinite is.integer is.language is.list is.logical is.matrix is.na is.name is.nan is.null is.numeric is.object is.pairlist is.raw is.recursive is.single is.symbol lazyLoadDBfetch length lgamma list log max min missing Mod names nargs nzchar oldClass on.exit pos.to.env proc.time prod quote range Re rep retracemem return round seq_along seq_len seq.int sign signif sin sinh sinpi sqrt standardGeneric substitute sum switch tan tanh tanpi tracemem trigamma trunc unclass untracemem UseMethod xtfrm"
                        ...
                        variants: [e.END_SAME_AS_BEGIN({ begin: /[rR]"(-*)\(/, end: /\)(-*)"/
                                ...
                                relevance: 0 }, { begin: "'", end: "'", relevance: 0 }] }, { relevance: 0, variants: [{ scope: {
                                    1: "operator", 2: "number"
                                }, match: [i, a] }, { scope: { 1: "operator", 2: "number" },
                                match: [/%[^%]*%/, a] }, { scope: { 1: "punctuation", 2: "number" }, match: [r, a] }, { scope: {
                                    2: "number"
                                }, match: [/[^a-zA-Z0-9._]|^/, a] }] }, { scope: { 3: "operator" },
                        match: [t, /\s+/, /<-/, /\s+/] }, { scope: "operator", relevance: 0, variants: [{ match: i }, {
                                match: /%[^%]*%/
                            }] }, { scope: "punctuation", relevance: 0, match: r }, { begin: "`", end: "`",
                        contains: [{ begin: /\\./ }] }] };
        }, grmr_ruby: e => {
            const n = e.regex, t = "([a-zA-Z_]\\w*[!?=]?|[-+~]@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?)", a = n.either(/\b([A-Z]+[a-z0-9]+)+/, /\b([A-Z]+[a-z0-9]+)+[A-Z]+/), i = n.concat(a, /(::\w+)*/), r = {
                ...
                variants: [{ begin: /'/, end: /'/ }, { begin: /"/, end: /"/ }, { begin: /`/, end: /`/ }, {
                    ...
                    }] }, g = "[0-9](_?[0-9])*", u = { className: "number",
                relevance: 0, variants: [{
                        ...
                        keywords: r
                    }] }, m = [d, { variants: [{ match: [/class\s+/, i, /\s+<\s+/, i] }, {
                            match: [/\b(class|module)\s+/, i]
                        }], scope: { 2: "title.class",
                        4: "title.class.inherited" }, keywords: r }, { match: [/(include|extend)\s+/, i], scope: {
                        2: "title.class"
                    }, keywords: r }, { relevance: 0, match: [i, /\.new[. (]/], scope: {
                        1: "title.class"
            ...
            return { name: "Rust", aliases: ["rs"], keywords: { $pattern: e.IDENT_RE + "!?", type: l,
                ...
                contains: [e.C_LINE_COMMENT_MODE, e.COMMENT("/\\*", "\\*/", { contains: ["self"]
                        ...
                        className: { 1: "keyword", 3: "title.class" } }, { begin: e.IDENT_RE + "::", keywords: {
                            keyword: "Self", built_in: o, type: l
        ...
        }, grmr_shell: e => ({ name: "Shell Session",
            ...
            return { name: "SQL", case_insensitive: !0, illegal: /[{}]|<\//, keywords: {
                    ...
                    built_in: ["current_catalog", "current_date", "current_default_transform_group", "current_path", "current_role", "current_schema", "current_transform_group_for_type", "current_user", "session_user", "system_time", "system_user", "current_time", "localtime", "current_timestamp", "localtimestamp"]
                        ...
                        match: o(["double precision", "large object", "with timezone", "without timezone"])
                                ...
                                match: /""/
                            }] }, e.C_NUMBER_MODE, e.C_BLOCK_COMMENT_MODE, t, { scope: "operator",
                        match: /[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/, relevance: 0 }] };
        },
        grmr_swift: e => {
            const n = { match: /\s+/, relevance: 0 }, t = e.COMMENT("/\\*", "\\*/", {
                contains: ["self"]
            }), a = [e.C_LINE_COMMENT_MODE, t], i = { match: [/\./, m(...ke, ...xe)],
                className: { 2: "keyword" } }, r = { match: b(/\./, m(...Me)), relevance: 0
            }, s = Me.filter((e => "string" == typeof e)).concat(["_|0"]), o = { variants: [{
                        className: "keyword",
                        match: m(...Me.filter((e => "string" != typeof e)).concat(Oe).map(Ne), ...xe)
                    }] }, l = {
                $pattern: m(/\b\w+/, /#\w+/), keyword: s.concat(Ce), literal: Ae
            }, c = [i, r, o], g = [{
                    match: b(/\./, m(...Te)), relevance: 0
                }, { className: "built_in",
                ...
                contains: x }, M = e => {
                const n = b(e, /\//), t = b(/\//, e);
                return { begin: n, end: t,
                    contains: [...x, { scope: "comment", begin: `#(?!.*${t})`, end: /$/ }] };
            }, A = {
                scope: "regexp", variants: [M("###"), M("##"), M("#"), O]
            }, S = { match: b(/`/, $e, /`/)
                    ...
                    scope: "keyword", match: b(/@/, m(...ze), d(m(/\(/, /\s+/)))
                }, { scope: "meta",
                    match: b(/@/, $e) }], R = { match: d(/\b[A-Z]/), relevance: 0, contains: [{ className: "type",
                        ...
                        match: /\.\.\./, relevance: 0
                    }, { match: b(/\s+&\s+/, d(Fe)), relevance: 0 }] }, D = {
            ...
            }, z = { match: [/operator/, /\s+/, Ie], className: {
                    1: "keyword", 3: "title"
                } }, j = { begin: [/precedencegroup/, /\s+/, Fe], className: {
                    1: "keyword", 3: "title"
                }, contains: [R], keywords: [...Se, ...Ae], end: /}/ }, U = {
            ...
            for (const e of k.variants) {
                ...
                n.keywords = l;
                const t = [...c, ...g, ...p, f, k, ...C];
                n.contains = [...t, { begin: /\(/, end: /\)/,
                        contains: ["self", ...t] }];
            }
            return { name: "Swift", keywords: l, contains: [...a, $, F, {
        ...
        grmr_typescript: e => {
            const n = e.regex, t = ve(e), a = me, i = ["any", "void", "number", "boolean", "string", "object", "never", "symbol", "bigint", "unknown"], r = {
                begin: [/namespace/, /\s+/, e.IDENT_RE], beginScope: { 1: "keyword", 3: "title.class" }
                    ...
                    keyword: "interface extends", built_in: i
            ...
            return n.contains.push("self"), { name: "WebAssembly", keywords: { $pattern: /[\w.]+/,
                    keyword: ["anyfunc", "block", "br", "br_if", "br_table", "call", "call_indirect", "data", "drop", "elem", "else", "end", "export", "func", "global.get", "global.set", "local.get", "local.set", "local.tee", "get_global", "get_local", "global", "if", "import", "local", "loop", "memory", "memory.grow", "memory.size", "module", "mut", "nop", "offset", "param", "result", "return", "select", "set_global", "set_local", "start", "table", "tee_local", "then", "type", "unreachable"]
                        ...
                        begin: [/(?:func|call|call_indirect)/, /\s+/, /\$[^\s)]+/], className: { 1: "keyword",
                            3: "title.function" }
                    }, e.QUOTE_STRING_MODE, { match: /(i32|i64|f32|f64)(?!\.)/,
            ...
            const n = "true false yes no null", t = "[\\w#;/?:@&=+$,.~*'()[\\]]+", a = {
            ...
            }, i = e.inherit(a, { variants: [{
                        begin: /'/, end: /'/, contains: [{ begin: /''/, relevance: 0 }]
                    }, { begin: /"/, end: /"/ }, {
                        begin: /[^\s,{}[\]]+/
                    }] }), r = { end: ",", endsWithParent: !0, excludeEnd: !0, keywords: n,
                ...
                begin: "\\[", end: "\\]", contains: [r], illegal: "\\n", relevance: 0
                    ...
                    relevance: 0
                }, { className: "type", begin: "!\\w+!" + t }, { className: "type",
